...
public class HistorialTest {
	...
	public void itemsByRecycleSiteAndRangeOfDates() {
		...
		Query q = entityManager.createQuery("FROM Historial h WHERE h.lugarReciclaje = :lr AND h.fechaReciclaje BETWEEN :date1 AND :date2");
		...
		System.out.println("items del punto de reciclaje con nombre "+lugarReciclajeAPersistir.getNombre()+" entre 1 ene y 21 oct: ");
